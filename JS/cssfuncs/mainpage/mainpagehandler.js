const MainPageHandler = {
	...
	setPrevExistingButtons() {
		MainPageHandler.showDiv('pedexist', localStorage.getItem(localStor.ped_save) !== null);

		MainPageHandler.showDiv('hapexist', localStorage.getItem(localStor.hap_save) !== null);
	},
